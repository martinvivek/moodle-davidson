...
//          Disable multiple instances of this block   // hanna 13/5/15
...
//            $this->content->icons[] = $OUTPUT->pix_icon('t/email', $send_email_str, 'moodle', $icon_class);  // was i/email  hanna 8/6/14
