...
if(!defined('CREPORT_CUSTOMSQL_MAX_RECORDS')) {
	define('CREPORT_CUSTOMSQL_MAX_RECORDS', 5000);
}
...
class report_sql extends report_base {
	...
	function execute_query($sql, $limitnum = CREPORT_CUSTOMSQL_MAX_RECORDS /* ignored */) {
        ...
        if (empty($reportlimit) or $reportlimit == '0') {
            $reportlimit = CREPORT_CUSTOMSQL_MAX_RECORDS;
        }
