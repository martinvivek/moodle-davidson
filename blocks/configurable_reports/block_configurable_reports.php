...
class block_configurable_reports extends block_list {
    ...
    public function applicable_formats() {
        return array('site' => true, 'course' => true, 'my' => true, 'mod'=>true);
    }
        ...
        if ($reports) {
            ...
            foreach($reports as $report){
                if($report->visible && cr_check_report_permissions($report, $USER->id, $context)){
                    ...
                    $anyvisiblereports = true;
                }
            }
            if (count($reports) && $anyvisiblereports)
                $this->content->items[] = '<hr style="border:5px double;width:700%">';
        }
