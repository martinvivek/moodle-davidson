...
/**
 * EssentialDavidson is a clean and customizable theme.
 *
...
/* Core */
$string['configtitle'] = 'EssentialDavidson';
$string['pluginname'] = 'EssentialDavidson';
$string['choosereadme'] = '
<div class="clearfix">
<div class="well">
<h2>EssentialDavidson</h2>
<p><img class="img-polaroid" src="essential/pix/screenshot.jpg" alt="EssentialDavidson screen shot"/></p>
</div>
<div class="well">
<h3>About EssentialDavidson</h3>
<p>EssentialDavidson is based upon the Bootstrap theme, which was created for Moodle 2.5, with the help of:<br>
...
<p>
<h3>EssentialDavidson for Moodle 3.0 kindly sponsored by:</h3>
<ul>
<li>Leila Hiret</li>
...
// Sponsor.
$string['sponsor_title'] = 'Sponsor EssentialDavidson';
$string['sponsor_desc'] = 'Please sponsor via PayPal by contacting me via my \'';
$string['sponsor_desc2'] = ' to keep the EssentialDavidson development going, or simply to express your gratitude.';
...
// Readme.
$string['readme_title'] = 'EssentialDavidson read-me';
$string['readme_desc'] = 'Please {$a->url} file, which contains more information about the EssentialDavidson theme including customisation.';
...
$string['coursecontentsearchdesc'] = "Enable course content search on the 'Dashboard' page.  Only works when EssentialDavidson is not in '\$CFG->themedir'.";
