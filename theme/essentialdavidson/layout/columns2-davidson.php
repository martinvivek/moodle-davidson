 ...
 */
$html = theme_essentialdavidson_get_html_for_settings($OUTPUT, $PAGE, 'side-post');
        ...
        <div id="page-content" class="row-fluid">
            <div id="<?php echo $regionbsid ?>" class="span12">
                <div class="row-fluid">
                    ...
                    if (!$footerregion) {
                        if (($hasboringlayout && $left) || (!$left)) {
                            ...
                            echo $OUTPUT->blocks('side-post', 'span3 pull-right');
                        }
                    }
                    ?>
                </div>
                ...
                if ($footerregion) {
                    ...
                    echo $OUTPUT->essential_blocks('side-post', 'row-fluid', 'aside', 4);
                }
                ?>
            </div>
        </div>
