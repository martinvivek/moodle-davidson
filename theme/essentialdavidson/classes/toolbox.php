...
namespace theme_essentialdavidson;
...
class toolbox {
    ...
    static public function get_csswww() {
        ...
        if (!self::lte_ie9()) {
            ...
            $url = \moodle_url::make_file_url("$CFG->wwwroot/pluginfile.php",
                            "/$syscontext->id/theme_essentialdavidson/style/$itemid/$moodlecss");
            ...
            $urlone = \moodle_url::make_file_url("$CFG->wwwroot/pluginfile.php",
                            "/$syscontext->id/theme_essentialdavidson/style/$itemid/$moodlecssone");
            $urlone = preg_replace('|^https?://|i', '//', $urlone->out(false));
            $urltwo = \moodle_url::make_file_url("$CFG->wwwroot/pluginfile.php",
                            "/$syscontext->id/theme_essentialdavidson/style/$itemid/$moodlecsstwo");
            ...
            if (property_exists($OUTPUT, 'essential')) {
                ...
                if (($corerenderer != null) && (property_exists($corerenderer, 'essential'))) {
                    ...
                    if (($corerenderer != null) && (property_exists($corerenderer, 'essential'))) {
                        ...
                        $us->corerenderer = $PAGE->get_renderer('theme_essentialdavidson', 'core');
                    }
                }
            }
        }
    ...
    static protected function check_colours_switch() {
        ...
        if (in_array($colours, array('default', 'alternative1', 'alternative2', 'alternative3', 'alternative4'))) {
            \set_user_preference('theme_essentialdavidson_colours', $colours);
        }
    }
    ...
    static public function initialise_colourswitcher(\moodle_page $page) {
        ...
        \user_preference_allow_ajax_update('theme_essentialdavidson_colours', PARAM_ALPHANUM);
        $page->requires->js_call_amd('theme_essentialdavidson/coloursswitcher', 'init',
    ...
    static public function get_colours($default = 'default') {
        $preference = \get_user_preferences('theme_essentialdavidson_colours', $default);
