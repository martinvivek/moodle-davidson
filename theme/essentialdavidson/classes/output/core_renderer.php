...
class core_renderer extends \core_renderer {
    ...
    public function navbar() {
        $breadcrumbstyle = \theme_essentialdavidson\toolbox::get_setting('breadcrumbstyle');
        if ($breadcrumbstyle) {
            ...
            if (($this->page->pagelayout == 'course') || ($this->page->pagelayout == 'incourse')) {
                $showcategories = \theme_essentialdavidson\toolbox::get_setting('categoryincoursebreadcrumbfeature');
            }
    ...
    public function footer() {
        ...
        if (defined('MDL_PERF') || (!empty($CFG->perfdebug) and $CFG->perfdebug > 7)) {
            ...
            if (defined('MDL_PERFTOFOOT') || debugging() || $CFG->perfdebug > 7) {
                $performanceinfo = $this->performance_output($perf, \theme_essentialdavidson\toolbox::get_setting('perfinfo'));
            }
        }
    ...
    public function heading($text, $level = 2, $classes = null, $id = null) {
        ...
        if (($level == 2) && ($this->page->pagelayout == 'incourse') && (is_object($this->page->cm)) &&
            (\theme_essentialdavidson\toolbox::get_setting('returntosectionfeature'))) {
            static $called = false;
            if (!$called) {
        ...
        if ($currentcatid) {
            ...
            if ($image) {
                ...
                if ($imageurl) {
                    ...
                    $parents = \theme_essentialdavidson\toolbox::get_categories_list()[$currentcatid]->parents;
    ...
    protected function return_to_section() {
        ...
        if ($markup === null) {
            ...
            if ($sectionnamelen !== false) {
                $sectionnamelimit = \theme_essentialdavidson\toolbox::get_setting('returntosectiontextlimitfeature');
            ...
            $title = get_string('returntosection', 'theme_essentialdavidson', array('section' => $sectionname));
    ...
    public function custom_menu_courses() {
        ...
        $hasdisplaymycourses = \theme_essentialdavidson\toolbox::get_setting('displaymycourses');
        if (isloggedin() && !isguestuser() && $hasdisplaymycourses) {
            $mycoursesorder = \theme_essentialdavidson\toolbox::get_setting('mycoursesorder');
            if (!$mycoursesorder) {
                $mycoursesorder = 1;
            }
            ...
            $mycoursetitle = \theme_essentialdavidson\toolbox::get_setting('mycoursetitle');
            if ($mycoursetitle == 'module') {
                $branchtitle = get_string('my'.$lateststring.'modules', 'theme_essentialdavidson');
            } else if ($mycoursetitle == 'unit') {
                $branchtitle = get_string('my'.$lateststring.'units', 'theme_essentialdavidson');
            } else if ($mycoursetitle == 'class') {
                $branchtitle = get_string('my'.$lateststring.'classes', 'theme_essentialdavidson');
            } else {
                $branchtitle = get_string('my'.$lateststring.'courses', 'theme_essentialdavidson');
            }
            ...
            $numcourses = 0;
            $hasdisplayhiddenmycourses = \theme_essentialdavidson\toolbox::get_setting('displayhiddenmycourses');
            ...
            if (($mycoursesorder == 1) || ($mycoursesorder == 2)) {
                ...
                if ($mycoursesorder == 1) {
                    ...
                    $sortorder = 'id';
                    $mycoursesorderidorder = \theme_essentialdavidson\toolbox::get_setting('mycoursesorderidorder');
            ...
            if ($courses) {
                $mycoursesmax = \theme_essentialdavidson\toolbox::get_setting('mycoursesmax');
                if (!$mycoursesmax) {
            ...
            if ($numcourses == 0 || empty($courses)) {
                $noenrolments = get_string('noenrolments', 'theme_essentialdavidson');
    ...
    public function custom_menu_themecolours() {
        ...
        if (!isguestuser()) {
            ...
            foreach (range(1, 4) as $alternativethemenumber) {
                if (\theme_essentialdavidson\toolbox::get_setting('enablealternativethemecolors' . $alternativethemenumber)) {
                    $alternativethemes[] = $alternativethemenumber;
                }
            }
            if (!empty($alternativethemes)) {
                $branchtitle = get_string('themecolors', 'theme_essentialdavidson');
                ...
                $defaultthemecolorslabel = get_string('defaultcolors', 'theme_essentialdavidson');
                ...
                foreach ($alternativethemes as $alternativethemenumber) {
                    if (\theme_essentialdavidson\toolbox::get_setting('alternativethemename' . $alternativethemenumber)) {
                        $alternativethemeslabel = \theme_essentialdavidson\toolbox::get_setting(
                            'alternativethemename'.$alternativethemenumber);
                    } else {
                        $alternativethemeslabel = get_string('alternativecolors', 'theme_essentialdavidson', $alternativethemenumber);
                    }
    ...
    public function custom_menu_activitystream() {
        ...
        if (!isguestuser()) {
            ...
            if (has_capability('moodle/course:manageactivities', $context)  ) {  //  hanna 16/8/15
                ...
                $branchtitle = get_string('thiscourse', 'theme_essentialdavidson');
                ...
                $branchtitle = get_string('people', 'theme_essentialdavidson');
    ...
    public function custom_menu_messages() {
        ...
        if (empty($totalmessages)) {
            ...
            $messagetitle = get_string('nomessagesfound', 'theme_essentialdavidson');
    ...
    private function get_time_difference($createdtime) {
        ...
        if (intval($timedifference / $years) > 1) {
            ...
            return get_string('ago', 'core_message', get_string('few', 'theme_essentialdavidson').get_string('seconds'));
        }
    }
    ...
    public function custom_menu_goto_bottom() {
        ...
        if (($this->page->pagelayout == 'course') || ($this->page->pagelayout == 'incourse') ||
            ...
            $menu->add($gotobottom, new moodle_url('#region-main'), get_string('gotobottom', 'theme_essentialdavidson'));
    ...
    public function custom_menu_editing() {
        $html = '';
        if (\theme_essentialdavidson\toolbox::get_setting('displayeditingmenu')) {
            if ($this->page->user_allowed_editing()) {
                ...
                if ($buttontoadd) {
                    ...
                    if (\theme_essentialdavidson\toolbox::get_setting('hidedefaulteditingbutton')) {
    ...
    */
    ...
    public function custom_menu_user() {
        ...
        if (!isloggedin()) {
            ...
            // Render Help Link.
            $usermenu .= $this->theme_essentialdavidson_render_helplink();
            ...
            if (\core\session\manager::is_loggedinas()) {
                ...
                $branchlabel = '<em>'.$this->getfontawesomemarkup('key').fullname($realuser, true).
                    get_string('loggedinas', 'theme_essentialdavidson').fullname($USER, true).'</em>';
            } else {
            ...
            if (is_mnet_remote_user($USER) && $idprovider = $DB->get_record('mnet_host', array('id' => $USER->mnethostid))) {
                $branchlabel = '<em>'.$this->getfontawesomemarkup('users').get_string('loggedinfrom', 'theme_essentialdavidson').
                    $idprovider->name.'</em>';
            ...
            $usermenu .= $this->theme_essentialdavidson_render_preferences($context);
            ...
            if ($course->id == SITEID) {
                $branchlabel = '<em>'.$this->getfontawesomemarkup('list-alt').get_string('mygrades', 'theme_essentialdavidson').'</em>';
                ...
                if (has_capability('gradereport/user:view', $context) && $course->showgrades) {
                    ...
                    $branchlabel = '<em>'.$this->getfontawesomemarkup('list-alt').
                        get_string('coursegrades', 'theme_essentialdavidson').'</em>';
     ...
     * @return string
     */
    protected function theme_essentialdavidson_render_helplink() {
        global $USER, $CFG;
        if (!\theme_essentialdavidson\toolbox::get_setting('helplinktype')) {
            return false;
        }
        ...
        if (\theme_essentialdavidson\toolbox::get_setting('helplinktype') === '1') {
            if (\theme_essentialdavidson\toolbox::get_setting('helplink') &&
                    filter_var(\theme_essentialdavidson\toolbox::get_setting('helplink'), FILTER_VALIDATE_EMAIL)) {
                $branchurl = 'mailto:' . \theme_essentialdavidson\toolbox::get_setting('helplink').'?cc='.$USER->email;
                ...
                $branchurl = preg_replace("(https?:)", "", $CFG->wwwroot).'/admin/settings.php?section=theme_essentialdavidson_header';
                $branchlabel = '<em>'.$this->getfontawesomemarkup('exclamation-triangle', array('red')).
                    get_string('invalidemail').'</em>';
            }
        }

        if (\theme_essentialdavidson\toolbox::get_setting('helplinktype') === '2') {
            if (\theme_essentialdavidson\toolbox::get_setting('helplink') &&
                    filter_var(\theme_essentialdavidson\toolbox::get_setting('helplink'),
                        FILTER_VALIDATE_URL, FILTER_FLAG_SCHEME_REQUIRED)) {
                $branchurl = \theme_essentialdavidson\toolbox::get_setting('helplink');
                $target = '_blank';
            } else if ((!\theme_essentialdavidson\toolbox::get_setting('helplink')) &&
     ...
     */
    protected function theme_essentialdavidson_render_preferences($context) {
        global $USER, $CFG;
    ...
    */
    ...
    public function render_social_network($socialnetwork) {
        if (\theme_essentialdavidson\toolbox::get_setting($socialnetwork)) {
            $icon = $socialnetwork;
            ...
            $socialhtml .= html_writer::start_tag('button', array('type' => "button",
                ...
                'onclick' => "window.open('".\theme_essentialdavidson\toolbox::get_setting($socialnetwork)."')",
                'title' => get_string($socialnetwork, 'theme_essentialdavidson'),
            ));
    ...
    public function standard_footer_html() {
        ...
        $output .= html_writer::start_tag('div', array ('class' => 'themecredit')).
            get_string('credit', 'theme_essentialdavidson',
            array('name' => html_writer::link('https://moodle.org/plugins/theme_essentialdavidson', 'Essential', array('target' => '_blank')))).
    ...
    public function essential_marketing_button($spot) {
        $o = '';
        $url = \theme_essentialdavidson\toolbox::get_setting('marketing'.$spot.'buttonurl');
        if (!empty($url)) {
            $url = '<a href="'.$url.'" ';
            $url .= 'target="'.\theme_essentialdavidson\toolbox::get_setting('marketing'.$spot.'target').'" class="marketing-button">';
            $url .= \theme_essentialdavidson\toolbox::get_setting('marketing'.$spot.'buttontext', true);
            $url .= '</a>';
        }
        $edit = $this->essential_edit_button('theme_essentialdavidson_frontpage');
    ...
    public function get_title($location) {
        ...
        if ($location === 'navbar') {
            ...
            switch (\theme_essentialdavidson\toolbox::get_setting('navbartitle')) {
                case 0:
                    return false;
                break;
                case 1:
            ...
            switch (\theme_essentialdavidson\toolbox::get_setting('headertitle')) {
                case 0:
                    return false;
                    break;
                case 1:
    ...
    protected function performance_output($param, $perfinfo) {
        ...
        $html .= html_writer::tag('h2', get_string('perfinfoheading', 'theme_essentialdavidson'));
        ...
        if ($colcount != 0) {
            ...
            if (isset($param['realtime'])) {
                ...
                $html .= html_writer::span(get_string('loadtime', 'theme_essentialdavidson'));
                $html .= html_writer::end_tag('div');
            }
            if (isset($param['memory_total'])) {
                $html .= html_writer::start_tag('div', array('class' => 'span'.$thespan));
                ...
                $html .= html_writer::span(get_string('memused', 'theme_essentialdavidson'));
                $html .= html_writer::end_tag('div');
            }
            if (isset($param['includecount'])) {
                $html .= html_writer::start_tag('div', array('class' => 'span'.$thespan));
                ...
                $html .= html_writer::span(get_string('included', 'theme_essentialdavidson'));
                $html .= html_writer::end_tag('div');
            }
            if (isset($param['dbqueries'])) {
                $html .= html_writer::start_tag('div', array('class' => 'span'.$thespan));
                ...
                $html .= html_writer::span(get_string('dbqueries', 'theme_essentialdavidson'));
                $html .= html_writer::end_tag('div');
            }
        }
        $html .= html_writer::end_tag('div');
        if ($perfinfo === "max") {
            ...
            $html .= html_writer::start_tag('div', array('class' => 'row-fluid'));
            $html .= html_writer::start_tag('div', array('class' => 'span12'));
            $html .= html_writer::tag('h2', get_string('extperfinfoheading', 'theme_essentialdavidson'));
            $html .= html_writer::end_tag('div');
            $html .= html_writer::end_tag('div');
            $html .= html_writer::start_tag('div', array('class' => 'row-fluid'));
            $colcountmax = 0;
            ...
            if ($colcountmax != 0) {
                ...
                if (isset($param['serverload'])) {
                    ...
                    $html .= html_writer::span(get_string('serverload', 'theme_essentialdavidson'));
                    $html .= html_writer::end_tag('div');
                }
                if (isset($param['memory_peak'])) {
                    $html .= html_writer::start_tag('div', array('class' => 'span'.$thespanmax));
                    ...
                    $html .= html_writer::span(get_string('peakmem', 'theme_essentialdavidson'));
                    $html .= html_writer::end_tag('div');
                }
                if (isset($param['cachesused'])) {
                    $html .= html_writer::start_tag('div', array('class' => 'span'.$thespanmax));
                    ...
                    $html .= html_writer::span(get_string('cachesused', 'theme_essentialdavidson'));
                    $html .= html_writer::end_tag('div');
                }
                if (isset($param['sessionsize'])) {
                    $html .= html_writer::start_tag('div', array('class' => 'span'.$thespanmax));
                    ...
                    $html .= html_writer::span(get_string('sessionsize', 'theme_essentialdavidson'));
                    $html .= html_writer::end_tag('div');
                }
                if (isset($param['dbtime'])) {
                    $html .= html_writer::start_tag('div', array('class' => 'span'.$thespanmax));
                    ...
                    $html .= html_writer::span(get_string('dbtime', 'theme_essentialdavidson'));
                    $html .= html_writer::end_tag('div');
                }
            }
            $html .= html_writer::end_tag('div');
    ...
    public function version_alert() {
        ...
        if (($CFG->version < 2016052300.00) || ($CFG->version >= 2016111400.00)) {
            ...
            $result .= '<span class="title">'.get_string('versionalerttitle', 'theme_essentialdavidson').'</span><br />'.
                get_string('versionalerttext1', 'theme_essentialdavidson').'<br />'.
                get_string('versionalerttext2', 'theme_essentialdavidson');
            $result .= '</div>';
        }
    ...
    public function favicon() {
        $favicon = \theme_essentialdavidson\toolbox::get_setting('favicon', 'format_file_url');
    ...
    /**
     * Display a special section above course's content with the:
     * Unit's name + the current activity's name + a user's completion radial progress bar.
     * (uses theme's javascript/d3js/radialProgress.js)
     */
    protected function theme_essentialdavidson_show_completion_progress()
    {
        global $COURSE, $PAGE;
        ...
        if (isset($_GET['navsection'])) {
            ...
            if (!empty($_COOKIE["navsection"])) {
                ...
                foreach ($modinfo->cms as $module) {
                    if (isset($module->id) && isset($PAGE->activityrecord->id) && $module->id == $PAGE->activityrecord->id) {
                        $navsection = (integer)$module->sectionnum;
                    }
                }
            }
        }
        if (isset($navsection)) {
            $thissection = $modinfo->get_section_info($navsection);
        } else {
            return ''; // no nav section found.
        }
...
//        }
        ...
        if (!$completioninfo->is_enabled()) {
            return ''; // no completion tracking was enabled in this course.
        }
        ...
        */
        ...
        if ($total > 0) {
            ...
            */
            ...
            // radialProgress
            $PAGE->requires->js('/theme/essentialdavidson/javascript/d3js/d3.min.js');
            $PAGE->requires->js('/theme/essentialdavidson/javascript/d3js/radialProgress.js');
            $PAGE->requires->js('/theme/essentialdavidson/javascript/d3js/init.js');
    ...
    protected function display_courseformatgrid_icons(){
        global $PAGE;

        echo html_writer::start_div('row-fluid fixedsections');
        ...
        for ($section = 1 ; $section <= $courseformatoptions['numsections']; $section++) {
            ...
            if ($showsection) {
                $sectionname = $courseformat->get_section_name($thissection);

                // Skip sections with names that do not start with ^
                // (So we are displaying fixed 4 sections in each course's header)
                if (substr($sectionname, 0, 1) == '^') {
                    $sectionname = ltrim($sectionname, '^');
                    $sectionname = html_writer::span($sectionname, 'btnz');

                    $thissection_modnumbers = $modinfo->sections[$thissection->section];
                    $fixedsection_firstmodinfo = $modinfo->cms[$thissection_modnumbers[0]];
                    if (isset($fixedsection_firstmodinfo) AND $fixedsection_firstmodinfo->uservisible ) {
                        //AND !empty($fixedsection_firstmodinfo->url)) {
                        echo html_writer::link($fixedsection_firstmodinfo->url.'&navsection='.($section).'&navfmodid='.$fixedsection_firstmodinfo->id,
                            $sectionname, array('class' => $linkclasses='span3', 'onclick' => $onclick=''));
                    }
   ...
   */
    ...
    private function user_action_menu($userid, $courseid = SITEID, $attributes ) {
        ...
        $actions[$url->out(false)] = get_string('user_viewprofile','theme_essentialdavidson');

        // View user's complete report
        $url = new moodle_url('/report/outline/user.php',
            array('id' => $userid, 'course'=>$courseid, 'mode'=>'complete'));
        $actions[$url->out(false)] = get_string('user_completereport','theme_essentialdavidson');

        // View user's outline report
        $url = new moodle_url('/report/outline/user.php',
            array('id' => $userid, 'course'=>$courseid, 'mode'=>'outline'));
        $actions[$url->out(false)] = get_string('user_outlinereport','theme_essentialdavidson');

        // Edit user's profile
        $url = new moodle_url('/user/editadvanced.php', array('id' => $userid, 'course'=>$courseid));
        $actions[$url->out(false)] = get_string('user_editprofile','theme_essentialdavidson');

        // Send private message
        if ($USER->id != $userid) {
            $url = new moodle_url('/message/index.php', array('id'=>$userid));
            $actions[$url->out(false)] = get_string('user_sendmessage','theme_essentialdavidson');
        }
        ...
        if (!empty($CFG->enablecompletion) AND $coursecompletion) {
            ...
            $actions[$url->out(false)] = get_string('user_coursecompletion','theme_essentialdavidson');
        }

        // All user's mdl_log HITS
        $url = new moodle_url('/report/log/user.php', array('id' => $userid, 'course'=>$courseid, 'mode'=>'all'));
        $actions[$url->out(false)] = get_string('user_courselogs','theme_essentialdavidson');

        // User's grades in course ID
        $url = new moodle_url('/grade/report/user/index.php', array('userid' => $userid, 'id'=>$courseid));
        $actions[$url->out(false)] = get_string('user_coursegrades','theme_essentialdavidson');
        ...
        if ($USER->id != $userid && !\core\session\manager::is_loggedinas() && has_capability('moodle/user:loginas', $coursecontext) && !is_siteadmin($userid)) {
            ...
            $actions[$url->out(false)] = get_string('user_loginas','theme_essentialdavidson');
        }
