...
//certificate_print_text($pdf, $x + 385  , $y + 100, 'C', 'freesans', '', 12, fullname($USER));
//certificate_print_text($pdf, $x + 135  , $y + 97, 'C', 'freesans', '', 14, $USER->idnumber);
...
certificate_print_text($pdf, $x + 270, $custy + 92, 'C', 'freesans', '', 12, $course->fullname);
...
//certificate_print_text($pdf, $x + 10, $y + 242, 'C', 'freesans', '', 12, $enddate_result->enddate . ' - ' . $startdate_result->startdate );
//certificate_print_text($pdf, $x + 45, $y + 242, 'L', 'freesans', '', 12, $schoolyear->studyyear);
...
certificate_print_text($pdf, $x + 125, $custy + 83, 'L', 'freeserif', '', 14, $gmulim->gmul);
