...
/**
 * Event when user profile is returned.
 *
 * @package    core
 * @since      Moodle 2.6
 * @copyright  2013 Rajesh Taneja <rajesh@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_returned extends base {
    ...
    public static function get_name() {
        return get_string('eventuserreturned', 'core_davidson');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' re-registered from davidson (drupal).";
    }
    ...
    /**
     * Return user_returned legacy event data.
     *
