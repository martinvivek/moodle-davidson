...
function enrollment_type(check) {
    ...
    var filterusers = document.getElementById("ifilterusers").value;
    ...
    var filteruser = getParameterByName('filteruser');
    document.getElementById('load_image').style.display = "block";
    if (document.getElementById("userid")) {
        var userid = document.getElementById("userid").value;
        url = url + "?enrollmenttype=" + check + "&roleid=" + roleid + "&userid=" + userid + "&courseid=" + temp
            + "&recovergrades=" + recovergrades + "&enrol_duration=" + enrol_duration + "&filteruser=" + filterusers;
    }
    else {
        url = url + "?enrollmenttype=" + check + "&roleid=" + roleid + "&filteruser=" + filterusers;
    }
