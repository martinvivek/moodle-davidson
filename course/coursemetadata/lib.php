...
define ('COURSEMETADATA_VISIBLE_NONE',    '0'); // only visible for moodle/user:update capability
...
class coursemetadata_field_base {
     ...
     */
    function coursemetadata_field_base($fieldid=0, $courseid=0) {  // hanna 2/8/16
     //function _construct($fieldid=0, $courseid=0) {
        global $USER;
...
//            echo "$field->datatype = $field->id, $course->id"; // todo:nadavkav remove
